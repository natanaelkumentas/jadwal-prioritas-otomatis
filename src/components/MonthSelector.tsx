    ...
    <div className="mb-4 sm:mb-6 p-3 sm:p-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 sm:gap-4 shadow-xs">
      ...
      <div className="flex items-center justify-between sm:justify-start gap-2 sm:gap-3">
        ...
        <button
          ...
          className="text-center sm:px-4 min-w-0 px-2.5 py-1 bg-slate-100 dark:bg-slate-950 hover:bg-slate-200 dark:hover:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg transition-all cursor-pointer group flex-1 sm:flex-initial relative overflow-hidden"
