    ...
    <div className="relative min-h-screen flex flex-col bg-slate-950 text-slate-100">
      ...
      <div className="mb-3 sm:mb-6 grid grid-cols-3 gap-1.5 sm:gap-4">
        ...
        <div 
          ...
          className="p-2 sm:p-4 bg-slate-900 border border-slate-800 hover:border-slate-700 rounded-lg cursor-pointer transition-all group relative overflow-hidden"
          title="Klik untuk Kelola Data Personel"
        >
          <div className="flex items-center justify-between">
            <div className="text-[9px] sm:text-xs font-semibold text-slate-500 uppercase tracking-wider group-hover:text-slate-300 transition-colors truncate">
              <span className="hidden sm:inline">{i18n.statsTotalStaff}</span>
              <span className="sm:hidden">Personel</span>
            </div>
            <span className="text-[9px] sm:text-xs bg-slate-800 group-hover:bg-slate-700 text-slate-300 px-1.5 sm:px-2 py-0.5 rounded font-bold transition-all border border-slate-700 flex items-center gap-1 flex-shrink-0">
              <FiUsers className="w-3 h-3 text-emerald-400" />
              <span className="hidden sm:inline">Kelola</span>
            </span>
          </div>
          <div className="text-base sm:text-2xl font-bold text-slate-200 group-hover:text-emerald-400 transition-colors mt-0.5 sm:mt-1">
        ...
        <div className="p-2 sm:p-4 bg-slate-900 border border-slate-800 rounded-lg">
          <div className="flex items-center justify-between">
            <div className="text-[9px] sm:text-xs font-semibold text-slate-500 uppercase tracking-wider truncate">
              <span className="hidden sm:inline">{i18n.statsGapsCount}</span>
              <span className="sm:hidden">Gap Shift</span>
            </div>
            <FiAlertCircle className="w-3.5 h-3.5 text-rose-400 flex-shrink-0" />
          </div>
          <div className="text-base sm:text-2xl font-bold text-rose-500 mt-0.5 sm:mt-1 flex items-center gap-1 sm:gap-2">
        ...
        <div className="p-2 sm:p-4 bg-slate-900 border border-slate-800 rounded-lg">
          ...
          <div className="text-base sm:text-2xl font-bold text-emerald-400 mt-0.5 sm:mt-1">
