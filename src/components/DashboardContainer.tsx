      ...
      <div className="mb-4 sm:mb-6 grid grid-cols-3 gap-2 sm:gap-4">
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs bg-slate-800 group-hover:bg-slate-700 text-slate-300 px-2 py-0.5 rounded font-bold transition-all border border-slate-700 flex items-center gap-1">
