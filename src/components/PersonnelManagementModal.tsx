        ...
        <div className="flex-1 overflow-y-auto p-3 sm:p-4 space-y-3">
          ...
          <div className="hidden sm:block overflow-x-auto rounded-lg border border-slate-200 dark:border-slate-800">
            <table className="min-w-full divide-y divide-slate-200 dark:divide-slate-800 text-xs">
              <thead className="bg-slate-100 dark:bg-slate-950 font-semibold text-slate-700 dark:text-slate-400">
                <tr>
              ...
              <tbody className="divide-y divide-slate-200 dark:divide-slate-800 bg-white dark:bg-slate-900/40">
                {filteredStaff.map(staff => (
                  <tr key={staff.id} className="hover:bg-slate-50 dark:hover:bg-slate-900/80 transition-colors">
          ...
          >
            ...
            <div className="flex items-center justify-end gap-3 pt-2 border-t border-slate-200 dark:border-slate-800">
              <button
                ...
                className="px-4 py-1.5 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs font-semibold rounded-lg border border-slate-300 dark:border-slate-700"
              >
                Batal
              </button>
              <button
                type="submit"
                disabled={isSubmitting}
                className="px-4 py-1.5 bg-slate-900 dark:bg-slate-200 hover:bg-slate-800 dark:hover:bg-slate-100 text-white dark:text-slate-900 text-xs font-bold rounded-lg transition-colors flex items-center gap-1.5 shadow-md"
              >
      ...
      {deletingStaff && (
        <div className="fixed inset-0 bg-slate-950/60 dark:bg-slate-950/90 backdrop-blur-md z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative z-[101] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl max-w-sm w-full p-5 shadow-2xl space-y-4">
            ...
            <div className="p-3 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-lg text-xs text-slate-700 dark:text-slate-300">
              Personel: <strong className="text-slate-900 dark:text-slate-100">{deletingStaff.name} ({deletingStaff.id})</strong>
            </div>
